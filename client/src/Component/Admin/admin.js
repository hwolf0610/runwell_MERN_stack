        ...
        axios.post(localStorage.getItem("url") + '/todos/Bedshow')
            .then((res) => {
                ...
                if (counter < 2) {
                    ...
                    this.setState({ pagercounter: counter / 2 })
                }
            }).catch((error) => {
                console.log(error)
            });
                                        ...
                                        <TableBody>
                                            {
                                                this.state.dataArray.map((item, index) => {
                                                    let start = this.state.offset * 2 - 1
                                                    let end = this.state.offset * 2 + 2
                                                        ...
                                                        return (
                                                            ...
                                                            >
                                                                <TableCell padding="checkbox">
                                                                    <img src={`http://localhost:3000/static/media/${item.mainimage}`} />
                                                                </TableCell>
                                                                <TableCell padding="checkbox">
